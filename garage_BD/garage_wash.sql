...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-10-2021 a las 04:44:42
...
(1, 'V-20123789', 'Pedro ', 'Suarez', 'Andres Eloy Blanco', '0412-1234567'),
(2, 'V-7852654', 'Maria ', 'Perdomo', 'Zona I con Av. Antonio Benitez', '0424-789639');
...
--
ALTER TABLE `factura_producto`
  ADD CONSTRAINT `factura_producto_ibfk_1` FOREIGN KEY (`id_producto`) REFERENCES `producto` (`id`),
  ADD CONSTRAINT `factura_producto_ibfk_2` FOREIGN KEY (`id_factura`) REFERENCES `factura` (`id`);
...
--
ALTER TABLE `medida`
  ADD CONSTRAINT `medida_ibfk_1` FOREIGN KEY (`id_tipo`) REFERENCES `tipo_medida` (`id`);
