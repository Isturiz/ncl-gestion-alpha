            ...
            foreach ($r1 as $valor) {
              if (isset($valor["nombre"])) {
                ...
                <td style="display: flex; border-style: none;  justify-content: center;">
                  ...
                  <form onsubmit="return ConfirmarEliminar();" action="../Usuario/usuario.php" method="POST">
                    <div class="d-flex justify-content-between align-items-center">
                      <input type="hidden" name="id" value="'.$valor['id'].'" />
...
<!--Inicio del Modal Registrar Usuario --> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="needs-validation" action="../../Controladores/Usuario/usuario.php" method="post">
          <div class="form-group row">
            <div class="col-md-4">
              <label for="recipient-name" style="padding-right: 20px;" class="col-form-label">Nombre:   </label>
