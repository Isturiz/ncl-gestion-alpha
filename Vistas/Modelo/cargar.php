    ...
    <div class="container">
      <main role="main" class="col-md-10 ml-sm-auto col-lg-10">
        <div class="pt-3 pb-2 mb-3 border-bottom" style="text-align:center;">
          <h1 class="h2">Gestión de Modelo</h1>
        </div> 
            ...
            foreach ($r1 as $valor) {
              ...
              if (isset($valor["nombre"])) {
                ...
                <td style="display: flex; border-style: none;  justify-content: center;">
                  ...
                  <form onsubmit="return ConfirmarEliminar();" action="../Modelo/modelo.php" method="POST">
                    <div class="d-flex justify-content-between align-items-center">
                      <input type="hidden" name="id" value="'.$valor['id'].'" />
...
<!--Inicio del Modal Registrar Modelo --> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="needs-validation" action="../../Controladores/Modelo/modelo.php" method="post">
          <div class="form-group row">
            <div class="col-md-6">
               <label for="message-text" class="col-form-label">Modelo:</label>
               <input type="text" class="form-control" name="nombre" placeholder="Indique el modelo de vehiculo" required>
            </div>
            <div class="col-md-6">
              ...
              <select class="form-control" name="id_marca" id="id_marca" >
                ...
                foreach ($r0 as $marca) {
                  if (isset($marca["nombre"])) {
                    $o='<option value="'.$marca['id'].'" >'.$marca['nombre'].'</option>'; 
                    print_r($o);
                    }
                  } ?>
              </select>
